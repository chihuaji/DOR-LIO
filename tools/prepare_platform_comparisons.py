...
SOURCES = [
    ('human', ROOT / 'videos/human/dorlio_reference_topdown_axes_stride10.mp4', ROOT / 'videos/human/fastlio2_reference_topdown_axes_stride10.mp4', False),
    ('stairs', Path('/home/hyd/dynamic_ws/stairs_compare_work/previews/user_side_v1/videos/seq01_3to2/dor_height.mp4'), Path('/home/hyd/dynamic_ws/stairs_compare_work/previews/requested_fastlio2_ws/videos/seq01_3to2/fast_height.mp4'), True),
    ('omni', Path('/home/hyd/dynamic_ws/omni_compare_work/videos/test2/dor_height.mp4'), Path('/home/hyd/dynamic_ws/omni_compare_work/videos/test2_requested/fast_height.mp4'), True),
]
